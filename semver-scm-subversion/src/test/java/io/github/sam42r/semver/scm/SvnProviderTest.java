...
class SvnProviderTest extends AbstractScmProviderTest {
    ...
    void shouldGetRemote() {

    }

    private void initialize(Path repository, Path workingCopy) throws Exception {
        initializeRepository(repository);
        checkoutWorkingCopy(repository, workingCopy);
    }
    ...
    private void checkoutWorkingCopy(Path repository, Path workingCopy) throws Exception {
